...
export const WeatherData = () => {
  ...
  const [currentHumid, setHumid] = useState("...")
      ...
      <PaperContainer>
        ...
        <Stack direction="row" sx={{ height: "100%" }}>
          ...
          <WeatherInfoFutureExtra flexGrow={1}>
            <WeatherInfoFutureExtraT>Relative Humidity: {currentHumid}%</WeatherInfoFutureExtraT>
          ...
          <WeatherInfoFutureExtra flexGrow={1} sx={{paddingRight: "30px"}}>
            <WeatherInfoFutureExtraT>Wind: {curerntWind}km/hr</WeatherInfoFutureExtraT>
            <WeatherInfoFutureExtraT>Precip: {currentPrecip}mm</WeatherInfoFutureExtraT>
          </WeatherInfoFutureExtra>
        </Stack>
      </PaperContainer>
    </MainContainer>
